...
#include "../Tests/DictionaryTests.h"
...
void interface() {
    ...
    while (Run) {
        ...
        cout << "4) Прогнать сравнительный loadTest для IDictionary" << endl;
        cout << "0) Выход" << endl;
        ...
        {
            case 4:{
                cout << "Введите размер IDictionary: ";
                int size;
                cin >> size;
                cout << "Введите размер кэша: ";
                int cacheSize;
                cin >> cacheSize;
                RunDictionaryTests(size, cacheSize);
                break;
            }
            case 1:{
